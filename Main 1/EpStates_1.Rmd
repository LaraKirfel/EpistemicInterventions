...
##Counterfactual Subgroup Analysis -- not used in paper
...
df.exp_long <- within(df.exp_long, ignorance <- relevel(knowledge, ref = 'Knowledge'))



library(VGAM)
vglm2 <- vglm(counterfactual ~ knowledge*scenario, family=multinomial(refLevel="environment"), df.exp_long)
vglm1 <- vglm(counterfactual ~ knowledge, family=multinomial(refLevel="environment"), df.exp_long)
vglm0 <- vglm(counterfactual ~ +1, family=multinomial(refLevel="environment"), df.exp_long)

####anove: test knowledge
